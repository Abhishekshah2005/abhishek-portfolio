...
// Source component shipped hot-linked ImageKit demo URLs tied to the
// author's own account — swapped for stable images.unsplash.com photos
// (verified reachable) so the default export still renders something out
// of the box for anyone who doesn't pass their own `cards`.
